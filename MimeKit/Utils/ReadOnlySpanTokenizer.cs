...
// Original Source: https://github.com/CommunityToolkit/dotnet/blob/main/CommunityToolkit.HighPerformance/Enumerables/ReadOnlySpanTokenizer%7BT%7D.cs
...
namespace MimeKit.Utils {
	...
	ref struct ReadOnlySpanTokenizer<T>
		where T : IEquatable<T>
	{
		...
		/// </summary>
		/// <returns>A <see cref="ReadOnlySpanTokenizer{T}"/> instance targeting the current <see cref="ReadOnlySpan{T}"/> value.</returns>
		[MethodImpl (MethodImplOptions.AggressiveInlining)]
